...
function AddProduct() {
  ...
  const handleAddProduct = async (e: FormEvent) => {
    ...
    try {
      ...
      // this is the firebase image url
      // that we will store in the database
      const productFirebaseImageLink = await getDownloadURL(storageRef);
      ...
      toast({
        variant: "destructive",
        title: "Error",
        description: "Something went wrong while uploading image to Firebase",
      });
    } finally {
      setSubmiting(false);
      setProductName("");
